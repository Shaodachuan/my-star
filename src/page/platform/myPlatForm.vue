      ...
      <Card :bordered="false">
          <Row class="my_tac">
            ...
            <Col span="8" class="my_pt30"> 
              <Row  class="my_pt10 my_pb10">
                  <my-plat-total :myContent="operationPlatform" myTitle="运营平台数量" mySrc="../../images/EMOJI-44.png"></my-plat-total>
              </Row>
              <Row class="my_pt10 my_pb10">
                  <my-plat-total :myContent="platformProblem" myTitle="问题平台数量"  mySrc="../../images/EMOJI-05.png"></my-plat-total>
              </Row>
              <Row class="my_pt10">
                  <my-plat-total :myContent="newProblem" myTitle="新上榜平台数量" mySrc="../../images/EMOJI-75.png"></my-plat-total>
              </Row>
            </Col>
          </Row>
      </Card>
        ...
        <!-- bottom -->
          <Card :bordered="false" class="my_mt20 my_pt10">  
            <router-link to="/platinfo">grade</router-link>
